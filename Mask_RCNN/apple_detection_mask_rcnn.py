...
class TrainingConfig(Config):
    ...
    BACKBONE = "resnet101"
    MEAN_PIXEL = np.array([106.5, 107.4,  99.2])
...
def train(model, dataset, config):
    """Train the model."""
    # Training dataset.
    dataset_train = MSUAppleDataset()
    dataset_train.load_object(dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = MSUAppleDataset()
...
#     # Validate arguments
#     dataset = '../dataset/'
#     weights = '../weights/mask_rcnn_apple_0025.h5'
#     logs = '../logs/'
#
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        class InferenceConfig(MSUAppleDataset):
